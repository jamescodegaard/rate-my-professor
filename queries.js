...
// INSERT INTO professors (first_name, last_name, title, school, department) VALUES ('John', 'Coughlin', 'Director', 'Canada University', 'Theatre'), ('Alex', 'Johnson', 'Associate Professor', 'Canada University', 'Biology'), ('Tiffany', 'Patterson', 'Senior Professor', 'Canada University', 'Marketing'), ('Daniel', 'Winkel', 'Teacher Assistant', 'Canada University', 'Physics'), ('David', 'Horina', 'Professor', 'University of Iowa', 'Accounting'), ('Jessica', 'Wooley', 'Director', 'University of Iowa', 'Theatre'),  ('Brian', 'Carbone', 'Director', 'University of Iowa', 'Philosophy'), ('Lisa', 'Newcar', 'Administrator', 'University of Iowa', 'Biology');
